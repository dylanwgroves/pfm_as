...
# Load Data ---------------------------------------------------------------
df <- read.csv("X:/Dropbox/Wellspring Tanzania Papers/Wellspring Tanzania - HetFX/01 Data/pfm2_villagesample_surveydates.csv")
...
ggsave("X:/Dropbox/Apps/Overleaf/Tanzania - Heterogeneous Treatment Effects/Figures/pfm2_gantt.pdf", plot = gantt, 
